...
export default function ProjectCard({ project }) {
  ...
  const mainStack = useMemo(() => {
    return Array.isArray(project?.stackPrincipale)
      ? project.stackPrincipale.slice(0, 4)
      : [];
  }, [project?.stackPrincipale]);

  const impactTags = useMemo(() => {
    return Array.isArray(project?.impactTags)
      ? project.impactTags.slice(0, 3)
      : [];
  }, [project?.impactTags]);

  const discreetInfos = useMemo(() => {
    return [
      ...new Set([
        ...(project?.languages || []),
        ...(project?.frameworks || []),
  ...
  }, [project?.languages, project?.frameworks, project?.outilsDev]);
    ...
    >
      <div className="project-card__inner">
        <section
          ...
          aria-label="Vue principale du projet"
        >
          {imageSrc && (
        ...
        <section
          ...
          aria-label="Vue technique du projet"
        >
          <div className="project-card__body">
            <header className="project-card__header">
            ...
            <div className="project-card__content">
              ...
              {mainStack.length > 0 && (
                ...
                >
                  ...
                  <ul
                    className="project-card__tags"
                    aria-label="Liste des technologies principales"
                  >
